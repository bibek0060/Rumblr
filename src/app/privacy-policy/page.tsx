        ...
        <div className="prose prose-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              Welcome to Rumblr. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600">
              ...
              <li>Profile Data: includes your profile information, posts, and interactions</li>
